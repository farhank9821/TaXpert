...
final calculationModelProvider = Provider<UserTaxCalculation>((ref) {
  final um = ref.watch(userModelProvider);
  ...
  // TODO:- tax already Paid

  // TODO net tax paid
  return UserTaxCalculation(
    grossIncome: grossIncome,
    taxPayableNew: taxable_income,
    taxPayableOld: taxable_income,
    taxableIncomeNew: calculateNewTax(taxable_income),
    taxableIncomeOld: calculateOldTax(taxable_income),
