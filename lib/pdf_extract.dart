...
//       while (i + 1 < lines.length && !lines[i + 1].startsWith('Book Profit under MAT, where applicable')) {
//         if (i + 2 < lines.length && lines[i + 2].startsWith('Book Profit under MAT, where applicable')) {
//           // If the next line (i+1) is part of "Total Income"
//           i = i + 1;
//           text += '${lines[i].trim()} ';
//           break;
//         } else if (i + 1 < lines.length && lines[i + 1].startsWith('Book Profit under MAT, where applicable')) {
//           // If the line after next (i+2) is part of "Total Income"
//           i = i + 2;
//           text += '${lines[i].trim()} ';
//           break;
//         }
//       }
//       dataMap['Total Income'] = text.trim();
